...
var Alien, AlienManager, SHIP_POSY, Ship, ShipShot, WIDTH, alienCallback, alienId, alienSteps, alienStepsDown, aliens, aliensDelta, am, gameOver, ship, shipCallback, shipShot, shipShotCallback;
...
gameOver = function() {
  ...
  return $('#game-over-screen').fadeIn();
};
